<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:84:"D:\phpstudy2\PHPTutorial\WWW\mytp5\public/../application/index\view\index\index.html";i:1589339923;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
        ...
        <div class="col-md-12">
            <table class="table table-hover table-bordered">
                ...
                <tr>
                    ...
                    <td>
                        <a href="" data-toggle="modal" onclick="values(<?php echo $active->getData('act_id'); ?>)" data-target="#appoint">
                        <span class="glyphicon glyphicon-log-in"></span>
                        <span id="appointText/">预约</span>
                        </a>
                    </td>
                </tr>
