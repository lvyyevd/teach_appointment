<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:86:"E:\phpstudy\PHPTutorial\WWW\mytp5\public/../application/index\view\teacher\update.html";i:1590571847;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
...
<body class="container">
    ...
    <form class="form-horizontal" action="<?php echo url('update'); ?>" method="post">
        <div class="form-group">
            ...
            <input type="hidden" class="form-control" name="act_id" value="<?php echo $active->act_id; ?>" id="major" placeholder="<?php echo $active->major; ?>"/>
            ...
            <div class="col-sm-9 inline-style ">
                <input type="text" class="form-control" name="major" id="major" placeholder="<?php echo $active->major; ?>"/>
            </div>
        </div>
        <div class="form-group">
            <!--<h2 class="form-signin-heading">注册</h2>-->
            ...
            <div class='input-group date'  id='datetimepicker1' style="padding: 0px 80px 0px 15px">
                <input type='text' class="form-control" name='starttime' placeholder="<?php echo $active->start_time; ?>"/>
        ...
        <div class="form-group">
            ...
            <div class='input-group date'  id='datetimepicker2' style="padding: 0px 80px 0px 15px">
                <input type='text' class="form-control" name='endtime' placeholder="<?php echo $active->end_time; ?>"/>
                <span class="input-group-addon">
                    <span class="glyphicon glyphicon-calendar"></span>
                </span>
            </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9  inline-style">
                <input type="text" class="form-control" name="addr" id="addr" placeholder="<?php echo $active->addr; ?>">
            </div>
        </div>
        <div class="form-group">
            <label for="exampleInputUsername1" class="col-sm-2 control-label  inline-style font-position-right">限制人数</label>
            <div class="col-sm-9  inline-style">
                <input type="text" class="form-control" name="nums" id="nums" placeholder="<?php echo $active->nums; ?>"/>
            </div>
            <div class="form-group">
            </div>
        </div>
