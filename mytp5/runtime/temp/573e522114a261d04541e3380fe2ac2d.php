<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:85:"E:\phpstudy\PHPTutorial\WWW\mytp5\public/../application/index\view\teacher\index.html";i:1590572773;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
            ...
            <table class="table table-hover table-bordered">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="update?tea_id=<?php echo $active->getData('tea_id'); ?>&act_id=<?php echo $active->getData('act_id'); ?>">修改</a>
