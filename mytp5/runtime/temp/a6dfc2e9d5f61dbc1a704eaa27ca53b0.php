<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:84:"D:\phpstudy2\PHPTutorial\WWW\mytp5\public/../application/index\view\teacher\add.html";i:1589210714;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
...
<body class="container">
    ...
    <form class="form-horizontal" method="get">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9  inline-style">
                <input type="tel" class="form-control" name="addr" id="addr" placeholder="M楼">
            </div>
        </div>
        <div class="form-group">
